...
#region Add To Log
    ...
    void AddToCurrent(string logText, int indent, bool important, bool isUndo)
    {
        ...
        else
        {
            ...
            int currentPosition = (int)PhotonNetwork.LocalPlayer.CustomProperties[ConstantStrings.Position];
    ...
    public void ShareTexts()
    {
        ...
        int currentPosition = (int)GetPlayerProperty(PhotonNetwork.LocalPlayer, ConstantStrings.Position);
    ...
    IEnumerator WaitAndContinue()
    {
        ...
        void Iterate(DecisionContainer container)
        {
            if (!container.complete)
            {
                if (currentContainer == null)
                {
                    //Debug.Log($"{container.action}({container.logged}) first assigned");
                ...
                else
                {
                    ...
                    {
                        currentContainer = container;
                        //Debug.Log($"{container.action}({container.logged}) is new container)");
                    }
                }
            }
            else
