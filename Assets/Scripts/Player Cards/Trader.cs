...
public class Trader : CardType
{
    ...
    protected override void DoAbilityOne(Player player, Card thisCard, int logged)
    {
        ...
        MakeDecision.inst.ChooseTextButton(new() { new(AutoTranslate.Sword(), Sword), new(AutoTranslate.Shield(), Shield) }, AutoTranslate.Choose_One_Instruction(thisCard.name));
    ...
    protected override void DoAbilityTwo(Player player, Card thisCard, int logged)
    {
        ...
        MakeDecision.inst.ChooseCardOnScreen(handCards, AutoTranslate.Discard_Instruction(thisCard.name), Discard);
